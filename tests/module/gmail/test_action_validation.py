...
from folker.module.gmail.action import GmailStageAction, GmailMethod, GmailStageSendAction
...
@pytest.mark.action_correctness
@pytest.mark.action_gmail
class TestGmailStageSendActionValidation:
    def test_correct_minimum(self):
        action = GmailStageSendAction(
            method=GmailMethod.SEND.name,
            sender="a_sender__email",
            recipients=["a_recipient_email"],
            subject="a_subject",
