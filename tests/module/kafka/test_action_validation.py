...
class TestKafkaActionValidation:
    def test_validate_missing_attribute_method(self):
        action = KafkaStageAction(host="a-host", topic="a-topic")
...
@pytest.mark.action_correctness
@pytest.mark.action_kafka
class TestKafkaPublishActionValidation:
    def test_validate_publish_with_key_correct(self):
        action = KafkaStagePublishAction(
            method=KafkaMethod.PUBLISH.name,
            host="a-host",
            topic="a-topic",
    ...
    def test_validate_correct_publish_minimum_key(self):
        action = KafkaStagePublishAction(
            method=KafkaMethod.PUBLISH.name, host="a-host", topic="a-topic", key="a-key"
        )
    ...
    def test_validate_missing_attribute_host(self):
        action = KafkaStagePublishAction(
            method=KafkaMethod.PUBLISH.name, topic="a-topic"
        )
    ...
    def test_validate_missing_attribute_topic(self):
        action = KafkaStagePublishAction(method=KafkaMethod.PUBLISH.name, host="a-host")
    ...
    def test_validate_missing_attribute_publish_key_and_message(self):
        action = KafkaStagePublishAction(
            method=KafkaMethod.PUBLISH.name, host="a-host", topic="a-topic"
        )
...
@pytest.mark.action_correctness
@pytest.mark.action_kafka
class TestKafkaSubscribeActionValidation:
    def test_validate_correct_subscribe(self):
        action = KafkaStageSubscribeAction(
            method=KafkaMethod.SUBSCRIBE.name,
            host="a-host",
            topic="a-topic",
            group="a-group",
        )
    ...
    def test_validate_correct_subscribe_minimum(self):
        action = KafkaStageSubscribeAction(
            method=KafkaMethod.SUBSCRIBE.name, host="a-host", topic="a-topic"
        )
