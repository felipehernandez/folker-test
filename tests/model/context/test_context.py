...
def test_complex_object_does_not_contains_variable_reference():
    assert [] == contains_variable_reference(Context())


def test_int_does_not_contains_variable_reference():
    assert [] == contains_variable_reference(1)


def test_dict_does_not_contains_variable_reference():
...
def test_complex_save_override():
    context = Context(secrets={},
                      test_variables={},
                      stage_variables={'k1': {'k2': {'k3': 'value'}}})
