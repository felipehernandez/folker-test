...
class RestActionExecutor(ActionExecutor):
    ...
    def _build_request_parameters(self, rest_action, stage_context, test_context):
        ...
        elif rest_action.data:
            call_parameters['data'] = recursive_replace_variables(test_context, stage_context, rest_action.data)
        ...
        if rest_action.params:
            call_parameters['params'] = rest_action.params
